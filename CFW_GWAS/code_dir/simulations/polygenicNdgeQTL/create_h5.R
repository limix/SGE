my_load = function(arg) {
    load(paste('data_dir/simulations/polygenicNdgeQTL/simulations/simulations',arg,'.RData',sep=''))
    return(simulations)
}
res = lapply(1:8,FUN = my_load)
...
library(rhdf5)
fid='data_dir/simulations/polygenicNdgeQTL/simulations/simulations.hdf5'
h5createFile(fid)
